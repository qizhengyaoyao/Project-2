      ...
      d3.json(lgaAPI, function (data) {
            ...
            d3.json(lgaCrimeData, function (cData) {
                  ...
                  d3.json(crimeTypes, function (cTypes) {
                        ...
                        var minCrime = max(lgaProperties.CRIME_TOTAL)
var maxCrime = min(lgaProperties.CRIME_TOTAL)
...
function getColour(d) {
      ...
      else if (d >= 4 && d < 5) { magColour = "#ffffb2"; }
      else if (d >= 3 && d < 4) { magColour = "#eee29c"; }
      else if (d >= 2 && d < 3) { magColour = "#dcc587"; }
      else if (d >= 1 && d < 2) { magColour = "#caa972"; }
      else if (d >= 0 && d < 1) { magColour = "#b88e5e"; }
      else if (d >= 0 && d < 1) { magColour = "#b88e5e"; }
      else if (d >= 0 && d < 1) { magColour = "#b88e5e"; }
      else if (d >= 0 && d < 1) { magColour = "#b88e5e"; }
      else if (d >= 0 && d < 1) { magColour = "#b88e5e"; }
